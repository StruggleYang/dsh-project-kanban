    ...
    function KanbanView(props) {
      ...
      const statsBar = (() => {
        ...
        return h('div', { key: 'sb', className: 'kan-stats' }, [
          ...
          ...labelCounts.map((x) => h('span', { key: 'l' + x.label }, LABEL_COLORS[x.label] ? { background: LABEL_COLORS[x.label] } : {}, x.label + ' ' + x.n)),
